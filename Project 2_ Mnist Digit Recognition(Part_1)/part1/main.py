...
def run_softmax_on_MNIST(temp_parameter):
    """
...
#     train_mod3, test_mod3 = update_y(train_y, test_y)
    
#     test_error = compute_test_error_mod3(test_x, test_mod3, theta, temp_parameter)
...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    train_x, train_y, test_x, test_y = get_MNIST_data()
    train_mod3, test_mod3 = update_y(train_y, test_y)
    theta, cost_function_history = softmax_regression(train_x, train_mod3, temp_parameter=1, alpha=0.3, lambda_factor=1.0e-4, k=10, num_iterations=150)
    plot_cost_function_over_time(cost_function_history)
    test_error = compute_test_error(test_x, test_mod3, theta, temp_parameter)
    return test_error
...
plot_cost_function_over_time(cost_function_history)
test_error_projected = compute_test_error(test_cube, test_y, theta, temp_parameter=1)

    
print('test_error_projected',test_error_projected)
